...
sample_idx = np.random.permutation(len(image_list))
sample_idx_mini_train = sample_idx[:3000].tolist()
sample_idx_val = sample_idx[3000:3900].tolist()
sample_idx_mini_val = sample_idx[3900:4000].tolist()
sample_idx_test = sample_idx[4000:5000].tolist()
sample_idx_train = sample_idx[5000:]
create_json(sample_idx_mini_val, 'mini_val_kaggle', image_list)
# create_json(sample_idx_val[:500], 'minimini_val_kaggle', image_list)
create_json(sample_idx_val, 'val_kaggle', image_list)
create_json(sample_idx_test, 'test_kaggle', image_list)
create_json(sample_idx_mini_train, 'mini_train_kaggle', image_list)
create_json(sample_idx_train, 'train_kaggle', image_list)
