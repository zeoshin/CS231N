...
class PN(nn.Module):
    def __init__(self, in_channels, in_depth):
        ...
        self.conv1 = nn.Conv3d(in_channels, 12, (3, 5, 5), 1, (1, 2, 2), bias=False)
        #self.conv1.weight.data /= 10
        ...
        self.conv2 = nn.Conv3d(12, 3, (in_depth, 7, 7), 1, (0, 3, 3), bias=False)
        #self.conv2.weight.data /= 10
